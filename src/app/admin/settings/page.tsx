      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden max-w-3xl">
        ...
        {loading ? (
          ...
          <form onSubmit={handleSave} className="p-6 space-y-6">
            ...
            {/* General Settings */}
            <div>
              <h3 className="text-sm font-bold text-gray-900 dark:text-gray-100 mb-3 border-b pb-2">General Platform</h3>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="number" value={settings.MAX_FILE_SIZE_MB} onChange={e => handleChange('MAX_FILE_SIZE_MB', e.target.value)} className="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 rounded-lg p-2.5 text-sm outline-none focus:ring-2 focus:ring-blue-500 border" />
                </div>
                <div>
                  <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Verification Expiry (Days)</label>
                  <input type="number" value={settings.VERIFICATION_EXPIRY_DAYS} onChange={e => handleChange('VERIFICATION_EXPIRY_DAYS', e.target.value)} className="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 rounded-lg p-2.5 text-sm outline-none focus:ring-2 focus:ring-blue-500 border" />
                </div>
              </div>
            </div>
