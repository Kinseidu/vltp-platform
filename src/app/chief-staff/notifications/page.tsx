...
export default function ChiefStaffNotificationsPage() {
  ...
  return (
    <DashboardLayout role="CHIEF_STAFF" userName={user.email} userEmail={user.email}>
      <NotificationBell role="CHIEF_STAFF" />
      <PageHeader
        title="Notifications"
      ...
      {notifications.length === 0 ? (
        <EmptyState icon={<Bell size={24} />} title="No notifications yet" message="Confirmation requests and platform updates will appear here." />
      ) : (
