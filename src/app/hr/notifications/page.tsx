              ...
              <div key={n.id} className="relative">
                <div
                  ...
                  className={`rounded-xl border p-4 cursor-pointer transition-all ${
                    isExpanded
                      ? 'rounded-b-none border-blue-300 bg-blue-50/50'
                      : n.isRead
                      ? 'bg-white border-gray-200 hover:border-blue-200 hover:bg-blue-50/20'
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <ChevronRight
                      size={16}
                      className={`text-gray-400 shrink-0 mt-1 transition-transform duration-200 ${isExpanded ? 'rotate-90' : ''}`}
                    />
                  </div>
                </div>
